...
- 入力は以下のいずれか:
  - `design-feature` スキルの成果物: `design-doc.md`
  - `design-feature` + `design-feature-tests` スキルの成果物: `design-doc.md` + `test-cases.md`
  - ユーザーからの直接入力
- 小さい単位で TDD サイクルを回す
...
`design-doc.md` があれば読み込む。`test-cases.md` もあれば読み込む。
...
**3.1. テストコード作成（基本パターン）**
- `test-cases.md` がある場合: テストケース設計に基づいてテストコードを実装
